...
export const devicesRoute: RouteSetup<{ name: string }> = {
    content: {
        ...
        child: deviceRoute,
        dataSource: {
            call: () => APIMap(Use(APIService).devices.get(), x => ({ name: x })),
            id: "name",
        },
    },
    displayText: "Devices",
